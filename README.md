...
## Requesting a Version Removal or Re-indexing

The OpenTofu Registry treats published provider and module versions as immutable and generally does **not** remove or re-index them. See the [Version Immutability policy](POLICY.md#version-immutability) for details and the situations in which an exception may be considered.

If your situation meets that bar, you can open one of the following issues:

- [Request Version Removal](https://github.com/opentofu/registry/issues/new?template=version-removal-request.yml)
- [Request Version Re-indexing](https://github.com/opentofu/registry/issues/new?template=version-reindex-request.yml)
